  ...
  return (
    <>
      <section className="foott">
        ...
        <div className="second-footerr">
          <p>2021 - 2023 focal x L.L.C All Right Reserved</p>
          <div className="second-footer22"></div>
        </div>
      </section>
    </>
  );
